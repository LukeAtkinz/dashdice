...
const MobileInventoryContext = createContext<InventoryContextType | undefined>(undefined);

export const useMobileInventory = () => {
  const context = useContext(MobileInventoryContext);
  if (context === undefined) {
    throw new Error('useMobileInventory must be used within a MobileInventoryProvider');
  }
  return context;
};

interface MobileInventoryProviderProps {
  children: React.ReactNode;
}

export const MobileInventoryProvider: React.FC<MobileInventoryProviderProps> = ({ children }) => {
  ...
  return (
    <MobileInventoryContext.Provider value={value}>
      {children}
    </MobileInventoryContext.Provider>
  );
};

// Export for compatibility with web app patterns
export const useInventory = useMobileInventory;
export const InventoryProvider = MobileInventoryProvider;