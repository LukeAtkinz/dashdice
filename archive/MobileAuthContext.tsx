...
const MobileAuthContext = createContext<AuthContextType | undefined>(undefined);
...
export const useAuth = useMobileAuth;
export const AuthProvider = MobileAuthProvider;