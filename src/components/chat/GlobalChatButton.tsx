  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-4 left-4 sm:bottom-4 sm:left-4 mb-20 sm:mb-0 z-40 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg transition-colors relative"
        style={{
