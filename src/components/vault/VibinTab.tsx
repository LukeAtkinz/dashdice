...
export default function VibinTab() {
  ...
  return (
    <>
      <div className="flex-1 overflow-y-auto overflow-x-hidden px-4 py-6 md:py-0 md:pt-6 h-full md:max-h-[calc(100vh-12rem)]">
            ...
            >
              ...
              <div className="flex flex-col gap-2 mt-auto w-full">
                <motion.button
                  ...
                  style={getEquipButtonStyle(isEquippedDisplay(item))}
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  {isEquippedDisplay(item) ? '✓ Equipped' : 'Equip Vibin'}
                </motion.button>
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {previewBackground?.id === item.id ? 'Hide Preview' : 'Preview Dashboard'}
                </motion.button>
              </div>
            </motion.div>
          ))}
