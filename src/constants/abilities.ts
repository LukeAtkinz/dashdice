...
export const LUCK_TURNER: DashDiceAbility = {
  ...
  iconUrl: '/Abilities/Catagories/Tactical/Luck%20Turner.webp',
...
export const PAN_SLAP: DashDiceAbility = {
  ...
  iconUrl: '/Abilities/Catagories/Defense/Pan%20Slap.webp',
...
export const SCORE_SAW: DashDiceAbility = {
  ...
  iconUrl: '/Abilities/Catagories/Attack/Score%20Saw.webp',
...
export const SCORE_SIPHON: DashDiceAbility = {
  ...
  iconUrl: '/Abilities/Catagories/Attack/Score%20Siphon.webp',
...
export const HARD_HAT: DashDiceAbility = {
  ...
  iconUrl: '/Abilities/Catagories/Defense/Hard%20Hat.webp',
  cooldown: 0,
  auraCost: 4,
  starCost: 4, // Power Rating: 4
