...
export const LUCK_TURNER: DashDiceAbility = {
  ...
  iconUrl: '/Abilities/Tactical/Luck Turner.webp',
...
export const PAN_SLAP: DashDiceAbility = {
  ...
  iconUrl: '/Abilities/Defense/Pan Slap.webp',
...
export const SCORE_SAW: DashDiceAbility = {
  ...
  iconUrl: '/Abilities/Attack/Score Saw.webp',
...
export const SCORE_SIPHON: DashDiceAbility = {
  ...
  iconUrl: '/Abilities/Attack/Score Siphon.webp',
...
export const HARD_HAT: DashDiceAbility = {
  ...
  iconUrl: '/Abilities/Defense/Hard Hat.webp',
  cooldown: 0,
  auraCost: 4,
  starCost: 4, // Power Rating: 4
